        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[#1b1b1d] text-[10px] font-mono text-[#e5e1e4]/40 uppercase border-b border-[#201f21]">
              ...
              <th className="px-4 py-4 font-medium">Platform A (YES)</th>
              <th className="px-4 py-4 font-medium">Platform B (NO)</th>
          ...
          <tbody className="text-[11px] font-mono divide-y divide-[#1b1b1d]">
            <tr className="hover:bg-[#39393b] transition-colors">
              <td className="px-6 py-5">
                <div className="font-bold text-[#e5e1e4] mb-1">Will the Fed cut rates in December?</div>
                <div className="flex gap-2 opacity-40 text-[9px]">KAL_FED_DEC_25 :: POLY_FED_RATE_CUT</div>
              </td>
              <td className="px-4 py-5">
                <div className="flex items-center gap-2">
                    <span className="text-[9px] bg-emerald-900/30 text-emerald-400 px-1.5 py-0.5 font-bold">KALSHI</span>
                    <span className="font-bold">58.0¢</span>
                </div>
              </td>
              <td className="px-4 py-5">
                  <div className="flex items-center gap-2">
                      <span className="text-[9px] bg-blue-900/30 text-blue-400 px-1.5 py-0.5 font-bold">POLYMARKET</span>
                      <span className="font-bold">38.5¢</span>
                  </div>
              </td>
              <td className="px-4 py-5 text-right font-bold text-[#e5e1e4]/40">96.5¢</td>
              <td className="px-4 py-5 text-right">
                <div className="text-emerald-500 font-bold">+3.5%</div>
